...
```ISVDB_LOCATION/src$ bsub R CMD BATCH '--args ../config/defaultCluster.yaml' ./genomerep/variantdb/dbdriver.R```  

To build the 15.04 version of the database (still experimental)

```ISVDB_LOCATION/src$ bsub R CMD BATCH '--args ../config/defaultCluster2.yaml' ./genomerep/variantdb/dbdriver.R```
